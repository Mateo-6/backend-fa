 ...
 */
export type { Budget } from '@mateo-6/fa-contracts';

/**
 * Period options for a budget.
 * TODO: replace with `export { BudgetPeriod } from '@mateo-6/fa-contracts'` once fa-contracts is pushed and reinstalled.
 */
